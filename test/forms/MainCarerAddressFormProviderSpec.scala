...
class MainCarerAddressFormProviderSpec extends StringFieldBehaviours {

  val form = new MainCarerAddressFormProvider()()

  ".line1" - {

    val fieldName = "line1"
    val requiredKey = "mainCarerAddress.error.line1.required"
    val lengthKey = "mainCarerAddress.error.line1.length"
    val maxLength = 100
