...
class ApplicantIsPartnerOfClaimantController @Inject()(
                                         ...
                                         formProvider: ApplicantIsPartnerOfClaimantFormProvider,
                                         val controllerComponents: MessagesControllerComponents,
                                         view: ApplicantIsPartnerOfClaimantView
      ...
      getAnswerAsync(ChildNamePage) { childName =>
        form.bindFromRequest().fold(
          ...
          value =>
            ...
            } yield Redirect(navigator.nextPage(ApplicantIsPartnerOfClaimantPage, mode, updatedAnswers))
        )
      }
  }
}
